<?php 
/*
Template Name: detail E-mail Template 2016
*/
get_header();  ?>
	<?php
              ...
              <div id="ecma">
               ...
               <tr>				
                ...
                <td valign="top"><strong>BA</strong></td>
						...
						<tr>	
						<td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Financial Services Management" value="Financial Services Management" <?php if(in_array( "Financial Services Management", $opleidingen)){ ?>checked<?php } ?> />
...
<tr>
  ...
  <tr>
    ...
    <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Werktuigbouwkunde" value="Werktuigbouwkunde" <?php if(in_array( "Werktuigbouwkunde", $opleidingen)){ ?>checked<?php } ?> />
                ...
                <tr>
                  <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Geschiedenis" value="Leraar Geschiedenis" <?php if(in_array( "Leraar Geschiedenis", $opleidingen)){ ?>checked<?php } ?> />
                	...
                	<td valign="top"><strong>Pabo</strong></td>
                        ...
                        <tr>
                           <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Scheikunde" value="Leraar Scheikunde" <?php if(in_array( "Leraar Scheikunde", $opleidingen)){ ?>checked<?php } ?> />
