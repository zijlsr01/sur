<?php  ob_start();
/*
Template Name: Mailingen Template 2016
*/
              ...
              <div id="ecma">
               ...
               <tr>				
                ...
                <td valign="top"><strong>BA</strong></td>
						...
						<tr>	
						<td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Financial Services Management" value="Financial Services Management" <?php if(!empty($_POST['opleiding']) && !empty($error) &&  in_array( "Financial Services Management", $_POST['opleiding'])){ ?>checked<?php } ?> />
                ...
                <tr>
                  <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Geschiedenis" value="Leraar Geschiedenis" <?php if(!empty($_POST['opleiding']) && !empty($error) &&  in_array( "Leraar Geschiedenis", $_POST['opleiding'])){ ?>checked<?php } ?> />
                	...
                	<td valign="top"><strong>Pabo</strong></td>
                        ...
                        <tr>
                           <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Scheikunde" value="Leraar Scheikunde" <?php if(!empty($_POST['opleiding']) && !empty($error) &&  in_array( "Leraar Scheikunde", $_POST['opleiding'])){ ?>checked<?php } ?> />
		...
		<table border="0" cellpadding="5" cellspacing="3">
				...
				?>
							<tr >
								...
								<td valign="top"><a href="httpss://www.expect-webmedia.nl/sur/mailingen-nieuw/?delml=<?php echo $maillijst->ID; ?>"  onclick="return confirm('Weet je zeker dat je deze E-mail wilt verwijderen?')">X</a></td>
							</tr>
				<?php } 
