<?php 
/*
Template Name: detailpagina Email TEST
*/
get_header();  ?>
	<?php
		...
		//mail versturen
			...
			if(!isset($_GET['send']) && isset($_GET['reminder'])){
				...
				if($_POST['maillijst']){
					...
					$wpdb->update( Maillijst, array( 'Naam' => $_POST['naam'], 'ActID' => $activiteiten, 'Geslacht' => $_POST['geslacht'], 'Opleiding' => $opleiding, 'Rijbewijs' => $_POST['rijbewijs'], 'Rondleiding' => $_POST['rondleiding'], 'Workshop' => $_POST['workshop'], 'OnlineVraagstuk' => $_POST['onlinevraagstuk'], 'WebcareKlus' => $_POST['webcareklus'], 'BrochureKlus' => $_POST['brochureklus'], 'InvoerKlus' => $_POST['invoerklus'], 'ID' => $mailID, 'comment' => $_POST['comments']),array( 'ID' => $mailID) );
		...
		<div class="contentContent">
			...
			<?php
				...
				if(!empty($error)){ ?>
					...
					<form action="https://www.expect-webmedia.nl/sur/mailing-detail-test/?mailID=<?php echo $mailID; ?> " method="post" name="instellingen">
					Onderwerp E-mail<br />
              ...
              <div id="ecma">
               ...
               <tr>				
                ...
                <td valign="top"><strong>BA</strong></td>
						...
						<tr>	
						<td valign="top"><input type="checkbox" class="check" name="Financial Services Management" id="Financial Services Management" value="Financial Services Management" <?php if(in_array( "Financial Services Management", $opleidingen)){ ?>checked<?php } ?> />
						  <label for="Financial Services Management">Financial Services Management</label></td>
						<td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Human Resource Management" value="Human Resource Management" <?php if(in_array( "Human Resource Management", $opleidingen)){ ?>checked<?php } ?> />
                        ...
                        <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Integrale veiligheid" value="Integrale veiligheid" <?php if(in_array( "Integrale veiligheid", $opleidingen)){ ?>checked<?php } ?> />
                        ...
                        <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Bestuurskunde" value="Bestuurskunde" <?php if(in_array( "Bestuurskunde", $opleidingen)){ ?>checked<?php } ?> />
                          ...
                          <tr>
                          <td></td>
                          <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="European Studies" value="European Studies"<?php if(in_array( "European Studies", $opleidingen)){ ?>checked<?php } ?> />
...
<tr>
  <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Commerciele Economie" value="Commerciele Economie" <?php if(in_array( "Commerciele Economie", $opleidingen)){ ?>checked<?php } ?> />
    <label for="Commerciele Economie">Commerciële Economie</label></td>
  <td valign="top"><input type="checkbox" class="check" name="opleiding[]"  value="Technische Bedrijfskunde" id="Technische Bedrijfskunde"<?php if(in_array( "Technische Bedrijfskunde", $opleidingen)){ ?>checked<?php } ?> />
    <label for="Technische Bedrijfskunde">Technische Bedrijfskunde</label></td>
  </tr>
<tr>
  <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="International Business en Languages" value="International Business en Languages" <?php if(in_array( "International Business en Languages", $opleidingen)){ ?>checked<?php } ?> />
...
<tr>
  <td valign="top"><strong>Comm/CMD</strong></td>			
                        ...
                        <tr>
                          <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Communicatie" value="Communicatie" <?php if(in_array( "Communicatie", $opleidingen)){ ?>checked<?php } ?> />
                            <label for="Communicatie">Communicatie</label></td>
                          <td></td>
                        </tr>
                        
                        	<tr>
                        	  <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Communications en Multimedia Design" value="Communications en Multimedia Design" <?php if(in_array( "Communications en Multimedia Design", $opleidingen)){ ?>checked<?php } ?> />
  ...
  <tr>
    <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Bouwkunde" value="Bouwkunde"<?php if(in_array( "Bouwkunde", $opleidingen)){ ?>checked<?php } ?> />
      <label for="Bouwkunde">Bouwkunde</label></td>
    <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Elektrotechniek" value="Elektrotechniek" <?php if(in_array( "Elektrotechniek", $opleidingen)){ ?>checked<?php } ?> />
      <label for="Elektrotechniek">Elektrotechniek</label></td>
    </tr>
  <tr>
    <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Civiele Techniek" value="Civiele Techniek" <?php if(in_array( "Civiele Techniek", $opleidingen)){ ?>checked<?php } ?> />
      <label for="Civiele Techniek">Civiele Techniek</label></td>
    <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Informatica"  value="Informatica"<?php if(in_array( "Informatica", $opleidingen)){ ?>checked<?php } ?> />
      <label for="Informatica">Informatica</label></td>
    </tr>
  <tr>
    <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Mobiliteit" value="Mobiliteit" <?php if(in_array( "Mobiliteit", $opleidingen)){ ?>checked<?php } ?> />
      <label for="Mobiliteit">Mobiliteit</label></td>
    <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Werktuigbouwkunde" value="Werktuigbouwkunde" <<?php if(in_array( "Werktuigbouwkund", $opleidingen)){ ?>checked<?php } ?> />
      <label for="Werktuigbouwkunde">Werktuigbouwkunde</label></td>
    </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Maritieme Techniek" value="Maritieme Techniek"<?php if(in_array( "Maritieme Techniek", $opleidingen)){ ?>checked<?php } ?> />
	...
	<td width="215" valign="top"><strong>Talen</strong></td>
        ...
        <tr>			
						...
						<td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Nederlands" value="Leraar Nederlands" <?php if(in_array( "Leraar Nederlands", $opleidingen)){ ?>checked<?php } ?> />
                        ...
                        <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Duits" value="Leraar Duits" <?php if(in_array( "Leraar Duits", $opleidingen)){ ?>checked<?php } ?> />
                        ...
                        <tr>
                          ...
                          <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Engels" value="Leraar Engels" <?php if(in_array( "Leraar Engels", $opleidingen)){ ?>checked<?php } ?> />
                            <label for="Leraar Engels">Leraar Engels</label></td>
                        </tr>	
                        
                                     <tr>
                                       <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Aardrijkskunde" value="Leraar Aardrijkskunde" <?php if(in_array( "Leraar Aardrijkskunde", $opleidingen)){ ?>checked<?php } ?> />
                                         <label for="Leraar Aardrijkskunde">Leraar Aardrijkskunde</label></td>          
	<td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Frans" value="Leraar Frans" <?php if(in_array( "Leraar Frans", $opleidingen)){ ?>checked<?php } ?> />
	  <label for="Leraar Frans">Leraar Frans</label></td>
	                                 </tr>

			
						<tr>
						  <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Algemene/Bedrijfseconomie" value="Leraar Algemene/Bedrijfseconomie" <?php if(in_array( "Leraar Algemene/Bedrijfseconomie", $opleidingen)){ ?>checked<?php } ?> />
						    <label for="Leraar Algemene/Bedrijfseconomie">Leraar Algemene/Bedrijfseconomie</label></td>			
						<td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Fries" value="Leraar Fries"<?php if(in_array( "Leraar Fries", $opleidingen)){ ?>checked<?php } ?> />
						  <label for="Leraar Fries">Leraar Fries</label></td>
						</tr>
				
                <tr>
                  <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Geschiedenis" value="Leraar Geschiedenis" <?php if(in_array( "Leraar Geschiedenis", $opleidingen)){ ?>checked<?php } ?> />
                	...
                	<td valign="top"><strong>Pabo</strong></td>
                        ...
                        <tr>
                          <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Gezondheidszorg en Welzijn" value="Leraar Gezondheidszorg en Welzijn" <?php if(in_array( "Leraar Gezondheidszorg en Welzijn", $opleidingen)){ ?>checked<?php } ?> />
                        ...
                        <tr>
                          <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Maatschappijleer" value="Leraar Maatschappijleer" <?php if(in_array( "Leraar Maatschappijleer", $opleidingen)){ ?>checked<?php } ?> />
                        ...
                        <tr>
                           <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Biologie" value="Leraar Biologie" <?php if(in_array( "Leraar Biologie", $opleidingen)){ ?>checked<?php } ?> />
                            <label for="Leraar Biologiee">Leraar Biologie</label></td>
                          <td></td>
                        </tr>
                        
                        <tr>
                           <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Scheikunde" value="Leraar Maatschappijleer" <?php if(in_array( "Leraar Scheikunde", $opleidingen)){ ?>checked<?php } ?> />
                            <label for="Leraar Scheikunde">Leraar Scheikunde</label></td>
                          <td valign="top">&nbsp;</td>
                        
                                  <tr>
		 <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Wiskunde" value="Leraar Wiskunde" <?php if(in_array( "Leraar Wiskunde", $opleidingen)){ ?>checked<?php } ?> />
                            <label for="Leraar Wiskunde">Leraar Wiskunde</label></td>
		<td valign="top">&nbsp;</td>	
                </tr>
        
                             <tr>
                                <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Leraar Natuurkunde" value="Leraar Natuurkunde" <?php if(in_array( "Leraar Natuurkunde", $opleidingen)){ ?>checked<?php } ?> />
                ...
                <td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Toegepaste Wiskunde" value="Toegepaste Wiskunde" <?php if(in_array( "Toegepaste Wiskunde", $opleidingen)){ ?>checked<?php } ?>>
	...
	<div class="alleZorgwelzijnUit aanUit">Deselecteer alle IEC opleidingen</div>
        ...
        <tr>
          ...
          <tr>
        	...
        	<td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Verpleegkunde"  value="Verpleegkunde"<?php if(in_array( "Verpleegkunde", $opleidingen)){ ?>checked<?php } ?> />
        	  <label for="Verpleegkunde">Verpleegkunde</label></td>
                    ...
                    <select name="onlinevraagstuk">
						<option value="nvt" <?php if($mailDetails->OnlineVraagstuk == "nvt"){ ?>selected="selected"<?php } ?>>Onbelangrijk</option>
						<option value="Ja" <?php if($mailDetails->OnlineVraagstuk == "Ja"){ ?>selected="selected"<?php } ?>>Ja</option>
						<option value="Nee" <?php if($mailDetails->OnlineVraagstuk == "Nee"){ ?>selected="selected"<?php } ?>>Nee</option>
					</select>
                    <br /><br />
                    ...
                    <select name="webcareklus">
						<option value="nvt" <?php if($mailDetails->WebcareKlus == "nvt"){ ?>selected="selected"<?php } ?>>Onbelangrijk</option>
						<option value="Ja" <?php if($mailDetails->WebcareKlus == "Ja"){ ?>selected="selected"<?php } ?>>Ja</option>
						<option value="Nee" <?php if($mailDetails->WebcareKlus == "Nee"){ ?>selected="selected"<?php } ?>>Nee</option>
					</select>
                    <br /><br />
                    ...
                    <select name="brochureklus">
						<option value="nvt" <?php if($mailDetails->BrochureKlus == "nvt"){ ?>selected="selected"<?php } ?>>Onbelangrijk</option>
						<option value="Ja" <?php if($mailDetails->BrochureKlus == "Ja"){ ?>selected="selected"<?php } ?>>Ja</option>
						<option value="Nee" <?php if($mailDetails->BrochureKlus == "Nee"){ ?>selected="selected"<?php } ?>>Nee</option>
					</select>
                    <br /><br />
                    Kan helpen bij invoerklus<br />
                      <select name="invoerklus">
						<option value="nvt" <?php if($mailDetails->InvoerKlus == "nvt"){ ?>selected="selected"<?php } ?>>Onbelangrijk</option>
						<option value="Ja" <?php if($mailDetails->InvoerKlus == "Ja"){ ?>selected="selected"<?php } ?>>Ja</option>
						<option value="Nee" <?php if($mailDetails->InvoerKlus == "Nee"){ ?>selected="selected"<?php } ?>>Nee</option>
					</select>
              ...
              <br /><br />
					...
					<br /><br />
					<a href="/sur/mailing-detail-test/?mailID=<?php echo $mailID; ?>">Annuleren</a><input type="submit" value="E-mail bijwerken" name="maillijst" id="submit">
				</form>
			...
			<table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
					...
					<td valign="top">:</td>
					<td valign="top"><?php if($mailDetails->OnlineVraagstuk == 'nvt'){echo "Onbelangrijk";}else{ echo $mailDetails->OnlineVraagstuk;} ?></td>
				</tr>
                <tr>
					<td valign="top" width="130">Kan helpen bij webcareklus</td>
					<td valign="top">:</td>
					<td valign="top"><?php if($mailDetails->WebcareKlus == 'nvt'){echo "Onbelangrijk";}else{ echo $mailDetails->WebcareKlus;} ?></td>
				</tr>
                <tr>
					<td valign="top" width="130">Kan helpen bij invoerklus</td>
					<td valign="top">:</td>
					<td valign="top"><?php if($mailDetails->InvoerKlus == 'nvt'){echo "Onbelangrijk";}else{ echo $mailDetails->InvoerKlus;} ?></td>
				</tr>
			</table>
		</div>
		<?php } ?>
	...
	<div id="contentRechts">
		...
		<div id="buttonContainer">
			...
			<div class="buttonNew" onclick="location.href='/sur/mailing-detail-test/?mailID=<?php echo $mailID; ?>&send=<?php echo $mailID; ?>';">
				Verstuur E-mail
			</div>
			<?php 
			$toDay = date('Ymd');
			...
			<div class="button2New" onclick="location.href='/sur/mailing-detail-test/?mailID=<?php echo $mailID; ?>&reminder=<?php echo $mailID; ?>';">
				Verstuur Reminder
			</div>
