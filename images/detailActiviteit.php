<?php 
/*
Template Name: detailpagina Activiteit
*/
get_header(); 
	...
	<div id="contentRechts">
		...
		<div class="contentContent">
			...
			<?php
				...
				<tr>
					<td valign="top" width="100"><?php mooiedatum($activiteit->Datum); ?></td>
					<td valign="top" width="250"><B><a href="https://www.expect-webmedia.nl/sur/detail/?id=<?php echo $activiteit->StudID; ?>" title="<?php studentOpleiding($activiteit->StudID); ?>" ><?php  studentNaam($activiteit->StudID); ?></a></B></td>
					<td valign="top" width="150"><a href="https://www.expect-webmedia.nl/sur/print-werkbriefjes/?actid=<?php echo $activiteit->ActID; ?>&userid=<?php echo $activiteit->StudID; ?>" target="_blank"><span>print werkbriefje</span></a></td>
					<td valign="top"><a href="https://www.expect-webmedia.nl/sur/activiteit-detail/?actid=<?php echo $activiteit->ActID; ?>&studid=<?php echo $activiteit->StudID; ?>&id=<?php echo $activiteit->ActID; ?>&delete=yes&dbID=<?php echo $activiteit->ID; ?>"  onclick="return confirm('Weet je zeker dat je deze aanmelding niet hoeft te werken?')" ><B>X</B></a></td>
				</tr>
				<?php }
		...
		<?php 
				global $wpdb;
				$afwezigen= $wpdb->get_results( "SELECT * FROM Aanmeldingen WHERE ActID = '".$actDetails->ID."' AND Afwezig = 'afwezig' OR Afwezig = 'afwezig2' ORDER BY ID DESC LIMIT 15" );
				?>
		...
		<div class="contentContent">
			...
			<?php
				...
				<tr>
					...
					<td valign="top" width="150"><img src="<?php bloginfo('template_url'); ?>/images/teruggetrokken.png" alt="" />Geert</td>
					<td valign="top"><a href="https://www.expect-webmedia.nl/sur/activiteit-detail/?actid=<?php echo $afwezig->ActID; ?>&studid=<?php echo $afwezig->StudID; ?>&id=<?php echo $afwezig->ActID; ?>&delete=yes"  onclick="return confirm('Weet je zeker dat je deze afmelding wilt verwijderen?')" ><B>X</B></a></td>
				</tr>
				<?php }
		...
		<div class="contentContent">
			...
			<?php
				...
				<tr>
					...
					<td valign="top"><a href="https://www.expect-webmedia.nl/sur/activiteit-detail/?actid=<?php echo $activiteit->ActID; ?>&studid=<?php echo $activiteit->StudID; ?>&id=<?php echo $activiteit->ActID; ?>&delete=yes&dbID2=<?php echo $afwezig2->ID; ?>"  onclick="return confirm('Weet je zeker dat je deze persoon wilt terug zetten naar deelnemers?')" ><B>X</B></a></td>
				</tr>
				<?php }
